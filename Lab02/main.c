...
int main(void) {
    ...
    while(1){
        ...
        /* button logic */
        while (checkInput() == 0){                // no buttons being pressed
            LATBbits.LATB8 = 0;
        }
        
        while (checkInput() == 0b0001){           // button 1
            LATBbits.LATB8 = 1;
            wait(400000);
            LATBbits.LATB8 = 0;
            wait(400000);
        ...
        while (checkInput() == 0b0010){           // button 2
            LATBbits.LATB8 = 1;
            wait(800000);
            LATBbits.LATB8 = 0;
            wait(800000);
        ...
        while (checkInput() == 0b0100){           // button 3
            LATBbits.LATB8 = 1;
            wait(1200000);
            LATBbits.LATB8 = 0;
            wait(1200000);
        ...
        while (checkInput() == 0b1111) {          // more than 1 button pressed
            LATBbits.LATB8 = 1;
        }
